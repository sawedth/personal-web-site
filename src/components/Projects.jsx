...
export default function Projects() {
    ...
    return (
        <div className={"projects w-[100%]  pt-[2rem] pb-[3rem] px-[16%] " + (mode ? "bg-[#CBF281]" : "bg-[#1A210B]")}>
            ...
            <div className={"w-[%100] min-h-[360px]  flex rounded-[12px] items-center mb-[3rem] py-[5px] shadow-md projects-card " + (mode ? "bg-white" : "bg-[#2B2727]")}>
                <img src={app1} key="app1" alt="app1" className='w-[360px] h-[360px] object-cover rounded-l-[5px] mr-[2rem] projects-card-photo' />
                <div className="m-[2rem] flex flex-col">
                    ...
                    <div className="text-left mb-[1rem] view-site">
            ...
            <div className={"w-[%100] min-h-[360px]  flex rounded-[12px] items-center mb-[3rem] py-[5px] shadow-md projects-card " + (mode ? "bg-white" : "bg-[#2B2727]")}>
                <img src={app2} key="app2" alt="app2" className='w-[360px] h-[360px] object-cover rounded-l-[5px] mr-[2rem] projects-card-photo ' />
                <div className="m-[2rem] flex flex-col">
